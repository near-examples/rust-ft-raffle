...
near call $CONTRACT_NAME ft_transfer '{"receiver_id": "'alice.$CONTRACT_NAME'", "amount": "10"}' --accountId $CONTRACT_NAME --depositYocto "1"
...
near call $CONTRACT_NAME ft_transfer '{"receiver_id": "'bob.$CONTRACT_NAME'", "amount": "10"}' --accountId $CONTRACT_NAME --depositYocto "1"
